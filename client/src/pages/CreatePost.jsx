  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        console.log("This is error message from Frontend generateImage()");
        console.log(error);
        // alert(error);
      } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        ...
        console.log(
          'This is error message from Frontend handleSubmit() which is "Share with the community"'
        );
        console.log(error);
        // alert(error);
      } finally {
      ...
      <form action="" className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <FormField
            ...
            value={form.prompt}
            handleChange={handleChange}
            // * This "isSurpriseMe" is a Random Prompt Generator
            isSurpriseMe
